    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.CharField(blank=True, choices=[('hombre', 'Hombre'), ('mujer', 'Mujer'), ('mixto', 'Mixto')], max_length=20, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Proveedor',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('repartidor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='usuarios_asignaciones', to='usuarios.repartidor')),
            ],
        ),
        migrations.CreateModel(
            name='TallaProducto',
